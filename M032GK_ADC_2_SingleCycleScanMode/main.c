...
int main()
{
    ...
    while(1){
            /* Set input mode Single Cycle Scan mode, and select channel 3 */
            ADC_Open(ADC, ADC_ADCR_DIFFEN_SINGLE_END, ADC_ADCR_ADMD_SINGLE_CYCLE, BIT3|BIT4|BIT5);
            ...
            for(u32ChannelCount = 3; u32ChannelCount < 6; u32ChannelCount++)
            {
